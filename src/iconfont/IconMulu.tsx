...
const IconMulu: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
    <Svg viewBox="0 0 1024 1024" width={size} height={size} {...rest}>
      <Path
        ...
        fill={getIconColor(color, 0, '#E5594F')}
      />
      <Path
        ...
        fill={getIconColor(color, 1, '#C45FA0')}
      />
      <Path
        ...
        fill={getIconColor(color, 2, '#F39A2B')}
      />
      <Path
        ...
        fill={getIconColor(color, 3, '#F0D043')}
      />
      <Path
        ...
        fill={getIconColor(color, 4, '#4A5699')}
      />
      <Path
        ...
        fill={getIconColor(color, 5, '#E5594F')}
      />
    </Svg>
  );
};
...
export default React.memo ? React.memo(IconMulu) : IconMulu;
